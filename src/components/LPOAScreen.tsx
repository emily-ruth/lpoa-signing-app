...
<head>
  <meta charset="UTF-8"/>
  <title>Limited Revocable Power of Attorney</title>
  <link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@600&display=swap" rel="stylesheet"/>
  <style>
    body { font-family: Georgia, serif; max-width: 680px; margin: 60px auto; color: #111; line-height: 1.7; font-size: 15px; }
    h1 { font-size: 24px; margin-bottom: 6px; }
    .label { font-size: 11px; letter-spacing: .08em; text-transform: uppercase; color: #666; margin-bottom: 2px; font-family: sans-serif; }
    .field { border-bottom: 1px solid #999; min-height: 40px; padding-bottom: 4px; margin-bottom: 20px; }
    .badge { display:inline-block; background:#e6f4ea; color:#1a7a35; border-radius:4px; padding:3px 10px; font-size:12px; font-family:sans-serif; font-weight:600; margin-bottom:16px; }
    strong { font-weight: 700; }
    @media print { body { margin: 40px; } }
  </style>
</head>
<body>
  <div class="badge">&#10003; Signed &amp; Active</div>
  <p style="font-size:11px;text-transform:uppercase;letter-spacing:.08em;color:#888;font-family:sans-serif;margin-bottom:4px">Legal Document</p>
  <h1>Limited Revocable Power of Attorney</h1>
  <hr style="margin:20px 0;border:none;border-top:1px solid #ddd"/>

  <p>I, the undersigned principal (the "Principal"), do hereby grant to BlackCloak, Inc., a Delaware corporation, and its employees and representatives (the "Agent"), as my agent to have the full power and authority to exercise the following powers:</p>
  <p>To exercise data rights on my behalf and to remove my personally identifiable information from third party websites and databases and to otherwise prevent third parties from sharing my personally identifiable information with others.</p>
  <p>This grant of authority includes all incidental acts as are reasonably necessary to carry out such powers.</p>
  <p><strong>Reliance.</strong> Any third party may rely upon the existence of this instrument and may deal in good faith with the Agent as if the Agent's authority were in full force and effect, unless such third party has actual knowledge of its revocation, termination, or invalidity.</p>
  <p><strong>Limitation.</strong> This grant of authority is limited to the powers described above, and does not include any other powers not expressly granted herein. Principal does not grant the Agent any authority over the Principal's property, finances, medical or healthcare decisions, or business affairs.</p>
  <p><strong>Revocation.</strong> The Principal shall have the unlimited right, at any time and for any reason, with or without cause, to revoke this power of attorney and the powers granted herein. This power of attorney shall automatically be revoked upon termination of the agreement between Principal and Agent.</p>
  <p><strong>Acceptance.</strong> The Agent accepts this appointment as power of attorney subject to the terms of this power of attorney and the agreement between Principal and Agent.</p>

  <hr style="margin:28px 0;border:none;border-top:1px solid #ddd"/>

  <div class="label">Signature</div>
  <div class="field">${sigHtml}</div>

  <div class="label">Printed Name</div>
  <div class="field">${sig.printedName}</div>

  <div class="label">Current City and State</div>
  <div class="field">${sig.cityState}</div>

  <div class="label">Effective Date</div>
  <div class="field">${sig.effectiveDate}</div>
</body>
</html>`;
  ...
  a.href = url;
  a.download = 'LPOA-BlackCloak-Signed.html';
  a.click();
